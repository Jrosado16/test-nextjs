...
export const rainbowWeb3AuthConnector = ({ chains, connectionType }: { chains: any, connectionType: string}) => {
  ...
  const web3AuthInstance = new Web3AuthNoModal({
    clientId: "dc798e9ad98c0433fa755ea2727fb491",
    chainConfig,
